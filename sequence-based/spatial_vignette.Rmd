...
jpeg(filename = "~/checks/output/images/spatial_vignette_ttr.jpg", height = 700, width = 1200, quality = 50)
print(plot)
dev.off()
```
...
```{r sc.data}
allen_reference <- readRDS("~/checks/spatial_vignette/allen_cortex.rds")
```
